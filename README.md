...
| [Thermostat](https://github.com/nikimanoledaki/thermostat)             |                                                 A single page application to control your thermostat, linked to a weather API and built with vanilla JavaScript and jQuery.                                                 |  5 days   |                                     JavaScript, Jasmine (testing), OpenWeatherMap (API for city temperatures), jQuery (JavaScript library)                                     |
